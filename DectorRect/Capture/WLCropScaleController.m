...
@interface WLCropScaleController ()

// 拉伸图
@property (nonatomic, strong) WLCropScaleView *cropScaleView;
// 完成按钮
...
@implementation WLCropScaleController
...
//
//        TransformCIFeatureRect rect =  [WLCGTransfromHelper transfromRealCIRectInPreviewRect:self.view.bounds imageRect:extent topLeft:topLeft topRight:topRight bottomLeft:bottomLeft bottomRight:bottomRight];
//
...
#pragma mark - Getter
- (WLCropScaleView *)cropScaleView
{
    if (!_cropScaleView) {
        _cropScaleView = [[WLCropScaleView alloc] initWithFrame:self.view.bounds];
    }
...
//    return destImg;
    return [WLDector dectorImage:destImg];
}
