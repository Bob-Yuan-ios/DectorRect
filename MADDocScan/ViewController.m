...
- (void)userContentController:(WKUserContentController *)userContentController
    ...
    if([method isEqualToString:SB]){
        ...
        [self.navigationController pushViewController:vc animated:YES];
         ...
         //图片下载
//         MADResultVC *vc = [[MADResultVC alloc] init];
...
//         //拍照
//         MADPhotoVC *vc = [[MADPhotoVC alloc] init];
//         vc.type = PHOTO_CAMERA;
//
//         __weak typeof(MADPhotoVC) *weakSelf = vc;
//         vc.dealPhotoBlock = ^(UIImage * _Nonnull image) {
//
//             MADCropScaleController *cropVC = [[MADCropScaleController alloc] init];
//             cropVC.cropImage = image;
//
//             __strong typeof(MADPhotoVC) *strongSelf = weakSelf;
